...
import {LogInUser, SignUp, SuspendUser, UnSuspendUser, EditProfile, LogoutUser, FindOneUser, FindAllUser, RefreshToken} from '../controller/auth.controller'
...
main_router.get('/user/refresh/:refreshtoken', ensureAuth, RefreshToken );
