...
main_router.delete('/delete/stockById/:id', ensureAuth, restrict([UserType.ADMIN, UserType.CUSTOMER, UserType.MODERATOR]), DeleteStockById);

main_router.put('/user/suspend/:id', ensureAuth, restrict([UserType.CUSTOMER, UserType.ADMIN, UserType.MODERATOR]), SuspendUser);

main_router.put('/user/unSuspend/:id', ensureAuth, restrict([UserType.CUSTOMER, UserType.ADMIN, UserType.MODERATOR]), UnSuspendUser);
